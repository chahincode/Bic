    ...
    <div style="width: 55%;margin: auto;padding: 22px;" class="well well-sm center">
      ...
      <form method="POST">
         <div class="form-group">
            <label for="some" class="col-form-label">Material</label>
          ...
          <div class="form-group">
            <label for="some" class="col-form-label">IP Adress OR SN</label>
            <input type="text" name="supplier"  class="form-control" id="some" required>
          </div>
          <div class="form-group">
            <label for="some" class="col-form-label">Mach Adress</label>
          ...
          <div class="form-group">
           ...
           <div class="form-group">
            <label for="some" class="col-form-label">Discription \ etat</label>
