  ...
  <div>
    ...
    <div class="item">
      <ul class="nostyle zero">
        ...
        <a href="inventeriess.php"><li><i class="fa fa-circle-o fa-fw"></i> Inventeries</li></a>
...
<div class="account" style="display: none;">
  ...
  ?>
    <a href="Inventeriess.php?id=<?php echo $row['id'] ?>"><div class="box2 col-md-3">
     <div class="center"> <img src="photo/<?php echo $row['pic'] ?>" style="width: 155px;height: 122px;" class='img-thumbnail'></div>
      ...
      <hr style="margin: 7px;">
      <span style="padding: 11px"><strong style="font-size: 10pt">Quantity</strong><span class="pull-right" style="color:blue;margin-right: 11px"><?php echo $row2['count(*)']; ?></span></span>
    </div></a>
  <?php
    }
   ?>
